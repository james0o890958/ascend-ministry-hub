...
const threads = [
  {
    ...
    last: "See you at the leaders meeting.",
    time: "10m",
    unread: 2,
  },
        ...
        <div className="grid lg:grid-cols-[20rem_1fr] divide-x divide-border min-h-[28rem]">
              ...
              {threads.map((t) => (
                <li key={t.id}>
                  <button
                    ...
                    className={cn(
                      "w-full text-left p-3 hover:bg-secondary/60 flex gap-3 items-center",
                      active === t.id && "bg-secondary/70",
                    )}
                  >
                    ...
                    <div className="text-right text-xs">
                      ...
                      {t.unread > 0 && (
                        <div className="mt-1 inline-flex h-5 min-w-5 items-center justify-center rounded-full bg-gold px-1.5 text-[10px] font-bold text-gold-foreground">
                          {t.unread}
                        </div>
                      )}
                    </div>
          ...
          <div className="flex flex-col">
                ...
                <div key={i} className={cn("flex", m.mine && "justify-end")}>
                  <div
                    className={cn(
                      ...
                      m.mine ? "bg-gradient-royal text-primary-foreground" : "bg-secondary",
                    )}
                  >
                    {m.text}
                  </div>
            ...
            <div className="border-t border-border p-3 flex gap-2">
              ...
              />
              <Button className="bg-gradient-royal text-primary-foreground" onClick={send}>
