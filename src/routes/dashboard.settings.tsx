...
function SettingsPage() {
  ...
  return (
    <div className="space-y-6">
      <PageHeader
        title="Settings"
        subtitle="Manage your account, branch and notification preferences."
      />
        ...
        <TabsContent value="profile" className="mt-4">
          <SectionCard title="Your profile">
            <div className="flex items-center gap-5">
              <Avatar className="h-20 w-20 ring-4 ring-gold/40">
            ...
            <div className="mt-6 grid gap-4 sm:grid-cols-2">
              ...
              <div className="space-y-1.5 sm:col-span-2">
                <Label>Email</Label>
                <Input defaultValue="daniel.okafor@ministry.org" />
              </div>
              <div className="space-y-1.5">
                <Label>Role</Label>
                <Input defaultValue="Lead Pastor" />
              </div>
              <div className="space-y-1.5">
                <Label>Phone</Label>
          ...
          <SectionCard title="Ministry details">
            <div className="grid gap-4 sm:grid-cols-2">
              <div className="space-y-1.5">
                ...
                <Input defaultValue="Soul Tracer Global" />
              </div>
              <div className="space-y-1.5">
              ...
              <div className="space-y-1.5">
                ...
                <Input defaultValue="Reaching the nations with the gospel of Christ." />
              </div>
            </div>
          </SectionCard>
        </TabsContent>
        ...
        <TabsContent value="security" className="mt-4">
          <SectionCard title="Security">
            ...
            <div className="mt-4 flex justify-end">
              <Button className="bg-gradient-royal text-primary-foreground">Update security</Button>
            </div>
          </SectionCard>
        </TabsContent>
      </Tabs>
