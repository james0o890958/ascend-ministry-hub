...
const features = [
  {
    ...
    desc: "Track every soul from first visit to ministry leadership with rich profiles and history.",
  },
  {
    icon: Compass,
    title: "Discipleship Journey",
    desc: "Visual stage timeline — Invitee, First Timer, Baptized, Foundation, Cell, Worker, Leader, Pastor.",
  },
  {
    icon: BarChart3,
    title: "Attendance Analytics",
    desc: "Service, midweek and cell attendance with monthly reports and percentage indicators.",
  },
  {
    icon: HeartHandshake,
    title: "Cell Ministry",
    desc: "Assign members, monitor cell leaders, and analyse cell growth across every region.",
  },
  {
    icon: Globe2,
    title: "Multi-Branch Control",
    desc: "Compare branches, view regional pastors and roll up statistics across the global ministry.",
  },
  {
    icon: ShieldCheck,
    title: "Role-Based Access",
    desc: "Pastors, leaders, workers and admins each see exactly what they need.",
  },
];
      ...
      <header className="sticky top-0 z-40 border-b border-white/10 bg-gradient-hero/95 backdrop-blur">
        <div className="mx-auto flex h-16 max-w-7xl items-center justify-between px-4 sm:px-6">
          ...
          <nav className="hidden items-center gap-8 text-sm font-medium text-white/80 md:flex">
            ...
            <a href="#journey" className="hover:text-gold transition">
              Journey
            </a>
            <a href="#branches" className="hover:text-gold transition">
              Churches
            </a>
            <a href="#stats" className="hover:text-gold transition">
              Impact
            </a>
          </nav>
        ...
        <div className="relative mx-auto grid max-w-7xl gap-12 px-4 py-20 sm:px-6 md:py-28 lg:grid-cols-2 lg:py-32">
          <motion.div initial="hidden" animate="show" variants={fade}>
            ...
            <p className="mt-6 max-w-xl text-lg text-white/75">
              Soul Tracer is the membership and discipleship operating system for global ministries
              — from the first visit to ordination, beautifully tracked across every church under
              your covering.
            </p>
      ...
      <section id="features" className="mx-auto max-w-7xl px-4 py-24 sm:px-6">
        <div className="mx-auto max-w-2xl text-center">
          ...
          <h2 className="mt-4 font-display text-4xl font-bold sm:text-5xl">
            Everything your ministry needs, in one sanctuary
          </h2>
          <p className="mt-4 text-muted-foreground">
            From attendance registers to ordination records — modular tools for the way the body of
            Christ actually grows.
          </p>
        </div>
          ...
          <div className="grid gap-12 lg:grid-cols-2 lg:items-center">
            <div>
              ...
              <h2 className="mt-4 font-display text-4xl font-bold sm:text-5xl text-balance">
                A clear path from the pew to the pulpit
              </h2>
              <p className="mt-4 text-muted-foreground">
                Every member moves along a visual journey — with mentors, completion dates, notes
                and notifications at every stage.
              </p>
              <Button
                asChild
                className="mt-6 bg-primary text-primary-foreground hover:bg-primary-glow"
              >
                <Link to="/dashboard/groups">
                  Explore the journey <ChevronRight className="ml-1 h-4 w-4" />
                </Link>
              </Button>
            </div>
      ...
      <section id="branches" className="mx-auto max-w-7xl px-4 py-24 sm:px-6">
        <div className="flex flex-wrap items-end justify-between gap-4">
          <div>
            ...
            <h2 className="mt-4 font-display text-4xl font-bold sm:text-5xl">
              One covering. Every branch in sight.
            </h2>
          </div>
          <p className="max-w-md text-muted-foreground">
            Roll-up dashboards, branch comparison, regional pastors — everything HQ needs to
            shepherd at scale.
          </p>
        </div>
          ...
          <div className="relative grid gap-8 lg:grid-cols-[1.4fr_1fr] lg:items-center">
            <div>
              ...
              <p className="mt-4 max-w-xl text-white/75">
                Launch in minutes. Onboard branches, import members, and start seeing the journey
                today.
              </p>
            </div>
        ...
        <div className="mx-auto grid max-w-7xl gap-10 px-4 py-14 sm:px-6 md:grid-cols-4">
          <div className="md:col-span-2">
            ...
            <p className="mt-4 max-w-sm text-sm text-muted-foreground">
              Soul Tracer is purpose-built for global ministries that disciple, raise leaders, and
              plant churches in every nation.
            </p>
          </div>
          <div>
