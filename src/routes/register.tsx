      ...
      <form className="space-y-4" onSubmit={(e) => e.preventDefault()}>
        <div className="grid grid-cols-2 gap-3">
          <div className="space-y-2">
            ...
            <Input value={first} onChange={(e) => setFirst(e.target.value)} placeholder="Daniel" />
          </div>
          <div className="space-y-2">
            <Label>Last name</Label>
            <Input value={last} onChange={(e) => setLast(e.target.value)} placeholder="Okafor" />
          </div>
        </div>
              ...
              <div className="rounded-lg border border-gold/30 bg-gold-soft/40 p-3 text-xs">
                ...
                <ol className="mt-2 space-y-1.5 text-muted-foreground">
                  <li className="flex gap-2">
                    <Mail className="mt-0.5 h-3.5 w-3.5 shrink-0 text-primary" /> We auto-suggest{" "}
                  ...
                  <li className="flex gap-2">
                    <CheckCircle2 className="mt-0.5 h-3.5 w-3.5 shrink-0 text-success" /> Edit it to
                    something you prefer.
                  </li>
                  <li className="flex gap-2">
                    <CheckCircle2 className="mt-0.5 h-3.5 w-3.5 shrink-0 text-success" /> Your inbox
                    is created at{" "}
                    <span className="font-mono text-foreground">
                      {finalGenerated || `you${DOMAIN}`}
                    </span>
                  </li>
                </ol>
              </div>
        ...
        <p className="text-xs text-muted-foreground">
          By creating an account you agree to our terms and ministry covenant.
        </p>
        <Button
          asChild
